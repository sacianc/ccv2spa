...
const repeatFrequency = ['D&iacute;a', 'Semanal', 'Mes'];
    ...
    public render(): JSX.Element {
        ...
        if (this.state.message.isRecurrence) {
            ...
            if (this.state.message.repeats !== "Personalizar") {
                ...
                if (this.state.message.repeatFrequency === repeatFrequency[0] || this.state.message.repeatFrequency === repeatFrequency[2]) {
                    recurrenceMessage += "every " + this.state.message.repeatFor + " " + repeatFrequency.toLowerCase();
                }
                else if (this.state.message.repeatFrequency === repeatFrequency[1]) {
                    let weeks = "";
                    ...
                    <div className="formContainer">
                        <div className="formContentContainer" >
                            ...
                            <div className="contentField">
                                <Flex>
                                    <FlexItem>
                                        <h3>Detalles de la programaci&oacute;n</h3>
                                    </FlexItem>
                                </Flex>
                                <Flex>
                                    <FlexItem>
