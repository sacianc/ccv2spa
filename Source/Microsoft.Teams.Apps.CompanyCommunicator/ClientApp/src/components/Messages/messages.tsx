        ...
        const processItem = (message: any) => {
            ...
            const out = {
                ...
                onClick: (): void => {
                    ...
                    this.onOpenTaskModule(null, url, "ver estado");
                },
